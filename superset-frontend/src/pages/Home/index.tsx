    ...
    <>
      ...
      <WelcomeContainer>
        <div style={{
          ...
          <div>
            <h2 style={{ color: '#ffffff', margin: 0, fontSize: '22px', fontWeight: 700 }}>
              🚀 Welcome to DataHub
            </h2>
            <p style={{ margin: '8px 0 0 0', opacity: 0.85, fontSize: '14px' }}>
              Your unified analytics platform — explore, visualize, and share your data effortlessly.
            </p>
          </div>
